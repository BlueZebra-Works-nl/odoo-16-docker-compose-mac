...
git clone --depth=1 https://github.com/BlueZebra-Works-nl/odoo-16-docker-compose-mac.git $DESTINATION
...
sudo launchctl kickstart -k system/com.apple.kext.caches
